...
import {
  ALL_TYPES, cleanNumericFields, prepareTransactionUpdate, fmtApiError,
  TxFormFields, TransactionEditModal,
} from '../components/TransactionEditModal'
  ...
  return (
    <div className="space-y-6">
      ...
      <TransactionEditModal
        ...
        onChangeFields={fields => setEditing(p => p ? { ...p, fields } : null)}
        accounts={accounts as Account[]}
        securities={securities as Security[]}
        ...
        onSave={() => {
          if (!editing) return
          updateMutation.mutate({ id: editing.tx.id, fields: prepareTransactionUpdate(editing.fields) })
        }}
      />
    </div>
  )
